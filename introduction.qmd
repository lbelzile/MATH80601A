...
Consider an $n$ sample of independent and identically distributed Gaussian, $Y_i \sim \mathsf{Norm}(0, \tau^{-1})$ ($i=1, \ldots, n$), where we assign a gamma prior on the precision $\tau \sim \mathsf{Ga}(\alpha, \beta)$. The posterior is
\begin{align*}
