...
col = cols[1]) +
 stat_function(
    fun = dbeta, 
    args = list(shape1 = 2, shape2 = 1.1), 
    xlim = c(0,1), 
    n = 1001L,
col = cols[2]) +
 stat_function(
    fun = dbeta, 
    args = list(shape1 = 0.9, shape2 = 0.9), 
    xlim = c(0,1), 
    n = 1001L,
col = cols[3]) +
...
\begin{align*}
 F_{1:k}(\boldsymbol{x}_{\boldsymbol{X}}) = \Pr(\boldsymbol{X}_{1:k} \leq \boldsymbol{x}_{1:k}) = F_{\boldsymbol{X}}(x_1, \ldots, x_k, \infty, \ldots, \infty).
\end{align*}
