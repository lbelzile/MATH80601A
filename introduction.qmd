...
Let $\boldsymbol{X}_1$, $\boldsymbol{X}_2$ be two random vectors. We say that $\boldsymbol{X}_1$ and $\boldsymbol{X}_2$ are independent if their joint distribution function factorizes as
\begin{align*}
...
\end{align*}
for any value of $\boldsymbol{x}_1$ and $\boldsymbol{x}_2$.
:::
