...
\end{align*}
We use indices to explicit which components of $\boldsymbol{X}$ are under consideration, with the convention ${1\!:\!d} = \{1, \ldots, d\}$.
...
A distribution is said to belong to a location scale family with location $\boldsymbol{\nu}$ and

:::


The most frequently encountered distribution is termed normal, but we use the terminology Gaussian in these notes.
