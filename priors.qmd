...
In practice, the maximum likelihood estimators do not exist if $\xi < -1$ as the model is degenerate [@Smith:1984], and the cumulant of order $k$ exists only if $\xi > -1/k$; the Fisher information matrix exists only when $\xi > -1/2$. Thus, informative priors that restrict the range of the shape, may be useful as in environmental applications the shapes would be in the vicinity of zero. @Martins.Stedinger:2000 proposed a prior of the form
\begin{align*}
