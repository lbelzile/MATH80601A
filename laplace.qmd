...
\begin{align*}
 \mathsf{E}_{\boldsymbol{\Theta} \mid \boldsymbol{Y}}(g(\boldsymbol{\theta}) \mid \boldsymbol{y}) &=  \frac{\int g(\boldsymbol{\theta}) p(\boldsymbol{y} \mid \boldsymbol{\theta} \mathrm{d} \boldsymbol{\theta}}{\int g(\boldsymbol{\theta}) p(\boldsymbol{y} \mid \boldsymbol{\theta} \mathrm{d} \boldsymbol{\theta}}
\end{align*}
We can apply
