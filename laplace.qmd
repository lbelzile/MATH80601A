...
Let us now use Laplace approximation to obtain an estimate of the marginal likelihood: because the model is conjugate, the true marginal likelihood equals
\begin{align*}
