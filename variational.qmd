...
#| message: false
#| label: fig-klvsrev
#| fig-cap: "Illustration of an approximation of a correlated bivariate Gaussian density (dashed contour lines) with an uncorrelated Gaussian, obtained by minimizing the reverse Kullback--Leibler divergence (variational approximation, left) and the Kullback--Leibler divergence."
