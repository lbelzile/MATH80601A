...
\end{align*}
where $\mathsf{Student}_{+}(0, a, 1)$ denotes a half-Cauchy distribution with scale $a>0,$ truncated on $\mathbb{R}_{+}$ @Carvalho.Polson.Scott:2010 use an improper prior for the scale $p(\omega^2) \propto 1/\omega^2.$
