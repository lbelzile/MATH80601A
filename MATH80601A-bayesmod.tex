...
and were last compiled on lundi, novembre 25 2024.
...
Let \(\boldsymbol{X}_1\), \(\boldsymbol{X}_2\) be two random vectors. We
say that \(\boldsymbol{X}_1\) and \(\boldsymbol{X}_2\) are independent
if their joint distribution function factorizes as \begin{align*}
F_{(\boldsymbol{X}_1, \boldsymbol{X}_2)}(\boldsymbol{x}_1, \boldsymbol{x_2}) = F_{\boldsymbol{X}_1}(\boldsymbol{x}_1)F_{\boldsymbol{X}_2}(\boldsymbol{x_2})
\end{align*} for any value of \(\boldsymbol{x}_1\) and
\(\boldsymbol{x}_2\).
...
\boldsymbol{Y}_1 \mid \boldsymbol{Y}_2 =\boldsymbol{y}_2 \sim \mathsf{normal}_k(\boldsymbol{\mu}_1+\boldsymbol{\Sigma}_{12} \boldsymbol{\Sigma}_{22}^{-1}(\boldsymbol{y}_2-\boldsymbol{\mu}_2), \boldsymbol{\Sigma}_{1|2}) \\& \sim 
\end{align*} and
\(\boldsymbol{\Sigma}_{1|2}=\boldsymbol{\Sigma}_{11}-\boldsymbol{\Sigma}_{12}\boldsymbol{\Sigma}_{22}^{-1}\boldsymbol{\Sigma}_{21}\)
