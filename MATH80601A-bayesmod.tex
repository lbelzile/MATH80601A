...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, colback=white, left=2mm, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{\textbf{Learning objectives}:}, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, breakable]
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, colback=white, left=2mm, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{\textbf{Summary}}, bottomrule=.15mm, leftrule=.75mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, arc=.35mm, rightrule=.15mm, breakable]
...
\FunctionTok{library}\NormalTok{(cubature)}
\NormalTok{ep\_update }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(mu\_lc, sd\_lc)\{}
  \CommentTok{\# Calculate outside of the loop the cavity}
\NormalTok{  fn }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(x)\{ }\FunctionTok{dnorm}\NormalTok{(x, }\AttributeTok{mean =}\NormalTok{ mu\_lc, }\AttributeTok{sd =}\NormalTok{ sd\_lc)}\SpecialCharTok{*}\FunctionTok{plogis}\NormalTok{(x)\}}
  \CommentTok{\# Compute normalizing constant}
\NormalTok{  cst }\OtherTok{\textless{}{-}} \FunctionTok{pcubature}\NormalTok{(}\AttributeTok{f =}\NormalTok{ fn, }\AttributeTok{lowerLimit =} \SpecialCharTok{{-}}\ConstantTok{Inf}\NormalTok{, }\AttributeTok{upperLimit =} \ConstantTok{Inf}\NormalTok{)}\SpecialCharTok{$}\NormalTok{integral}
\NormalTok{  mu }\OtherTok{\textless{}{-}} \FunctionTok{pcubature}\NormalTok{(}\AttributeTok{f =} \ControlFlowTok{function}\NormalTok{(x)\{}\FunctionTok{fn}\NormalTok{(x)}\SpecialCharTok{*}\NormalTok{x\}, }\SpecialCharTok{{-}}\ConstantTok{Inf}\NormalTok{, }\ConstantTok{Inf}\NormalTok{)}\SpecialCharTok{$}\NormalTok{integral}\SpecialCharTok{/}\NormalTok{cst}
\NormalTok{  va }\OtherTok{\textless{}{-}} \FunctionTok{pcubature}\NormalTok{(}\AttributeTok{f =} \ControlFlowTok{function}\NormalTok{(x)\{}\FunctionTok{fn}\NormalTok{(x)}\SpecialCharTok{*}\NormalTok{(x}\SpecialCharTok{{-}}\NormalTok{mu)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{\}, }\SpecialCharTok{{-}}\ConstantTok{Inf}\NormalTok{, }\ConstantTok{Inf}\NormalTok{)}\SpecialCharTok{$}\NormalTok{integral}\SpecialCharTok{/}\NormalTok{cst}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
