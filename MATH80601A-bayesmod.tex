...
and were last compiled on lundi, octobre 16 2023.
...
{\centering \includegraphics{./mcmc_files/figure-pdf/fig-acceptreject-1.pdf}
...
the lag \(t\) correlation, as in Small values (less than a few hundreds)
is not enough for estimating. The relative effective sample size is
simply the fraction of the effective sample size over the Monte Carlo
number of replications: small values of \(\mathsf{ESS}/B\) indicate
pathological or inefficient samplers. If the ratio is larger than one,
it indicates the sample is superefficient (as it generates negatively
correlated draws).
...
{\centering \includegraphics{./mcmc_files/figure-pdf/fig-mcmc-batchmean-1.pdf}
...
{\centering \includegraphics{./mcmc_files/figure-pdf/fig-Gibbs-steps-1.pdf}
...
{\centering \includegraphics{./mcmc_files/figure-pdf/fig-gibbs-normal-1.pdf}
...
Z_i \mid Y_i=y_i, \boldsymbol{\beta} \begin{cases}
...
\begin{example}[Bayesian LASS0]\label{exm-student-mixture-gaussian}
...
{\centering \includegraphics{./mcmc_files/figure-pdf/fig-posterior-pred-check-1.pdf}
...
{\centering \includegraphics{./mcmc_files/figure-pdf/fig-loocv-qqplots-1.pdf}

}

\caption{\label{fig-loocv-qqplots}Quantile-quanitle plots based on
