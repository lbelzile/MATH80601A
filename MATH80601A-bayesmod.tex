...
LASS0]\protect\hypertarget{exm-student-mixture-gaussian}{}\label{exm-student-mixture-gaussian}
...
\end{align*} This yields a Laplace penalty on the regression
coefficients, with lower values of \(\lambda\) yielding more shrinkage.
Note that, in the Bayesian LASSO, none of the posterior draws of
\(\boldsymbol{\beta}\) are exactly zero.
