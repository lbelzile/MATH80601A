...
and were last compiled on Sunday, October 29 2023.
...
and Casella (\protect\hyperlink{ref-Park.Casella:2008}{2008}), fitted to
the \texttt{diabetes} data. Note that, contrary to the frequentist
setting, none of the posterior draws of \(\boldsymbol{\beta}\) are
exactly zero.

\begin{figure}[ht!]

{\centering \includegraphics{mcmc_files/figure-pdf/fig-lasso-traceplot-1.pdf}
...
{\centering \includegraphics{mcmc_files/figure-pdf/fig-rhat-1.pdf}
...
{\centering \includegraphics{mcmc_files/figure-pdf/fig-waic-blasso-1.pdf}
