...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, arc=.35mm, colback=white, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{\textbf{Learning objectives}:}, coltitle=black, toptitle=1mm, breakable, toprule=.15mm, left=2mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, arc=.35mm, colback=white, opacityback=0, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{\textbf{Summary}}, coltitle=black, toptitle=1mm, breakable, toprule=.15mm, left=2mm, bottomrule=.15mm, colframe=quarto-callout-important-color-frame, titlerule=0mm, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white]
...
fraction relative to the number of samples ranges from 15\% to 100\%,
compared to 50\% to 96\% for the Bayesian LASSO and near-independent
