...
approximation (dashed orange) and variational Gaussian approximation
(dotted blue).}
...
posterior unless we draw samples from it. Consider
\(g(\boldsymbol{\theta};\boldsymbol{\psi})\) with
...
\(\boldsymbol{\Theta}:\) we can then rewrite \begin{align*}
