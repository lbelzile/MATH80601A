...
and were last compiled on Sunday, January 05 2025.
...
models. We will encounter exponential families when discussing conjugate
priors.
...
\(Y\) and \(f_{X,Y}\) the joint density. Bayes' theorem states that
\begin{align*}
