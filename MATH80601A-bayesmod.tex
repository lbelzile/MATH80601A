...
\frontmatter
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, frame hidden, sharp corners, interior hidden, enhanced, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi
...
\(p \sim \mathsf{Be}(\alpha, \beta)\) and observe \(y\) successes, the
...
posterior distribution is \(\mathsf{Be}(y+\alpha, n-y+\beta)\) and
