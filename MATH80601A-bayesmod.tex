...
\pandocbounded{\includegraphics[keepaspectratio]{introduction_files/figure-pdf/fig-beta-dens-1.pdf}}

}

\caption{\label{fig-beta-dens}Density of beta random variables with
