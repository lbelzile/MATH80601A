...
and were last compiled on Thursday, October 19 2023.
...
\leavevmode\vadjust pre{\hypertarget{exm-betabinomconjugate}{}}%
\begin{example}[Binomial model with beta
prior]\label{exm-betabinomconjugate}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-betabinom-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-binom-massvslik-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{prp-sequentiality}{}}%
\begin{proposition}[Sequentiality and Bayesian
updating]\label{prp-sequentiality}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-sequential-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-numericalintegration}{}}%
\begin{example}[]\label{exm-numericalintegration}
...
\CommentTok{\#\textgreater{} 0.0000107 with absolute error \textless{} 1e{-}12}
...
\CommentTok{\#\textgreater{} [1] 0.0000107}
...
\CommentTok{\#\textgreater{} [1] 0.0000106}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-betabinompostpred-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-normal-post-pred}{}}%
\begin{example}[Posterior predictive distribution of univariate Gaussian
with known mean]\label{exm-normal-post-pred}
...
\leavevmode\vadjust pre{\hypertarget{def-lossfunction}{}}%
\begin{definition}[Loss function]\label{def-lossfunction}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-central-moments-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-loss-extremes}{}}%
\begin{example}[Danish insurance losses]\label{exm-loss-extremes}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-danish-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-lossfn-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{def-credible-region}{}}%
\begin{definition}[]\label{def-credible-region}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./introduction_files/figure-pdf/fig-credible-intervals-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-bixi-temp}{}}%
\begin{example}[]\label{exm-bixi-temp}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./priors_files/figure-pdf/fig-bixi-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{def-conjugate-prior}{}}%
\begin{definition}[]\label{def-conjugate-prior}
...
\leavevmode\vadjust pre{\hypertarget{exm-conjugatepriors-binom}{}}%
\begin{example}[Conjugate prior for the binomial
model]\label{exm-conjugatepriors-binom}
...
\leavevmode\vadjust pre{\hypertarget{exm-conjugatepriors-poisson}{}}%
\begin{example}[Conjugate prior for the Poisson
model]\label{exm-conjugatepriors-poisson}
...
\leavevmode\vadjust pre{\hypertarget{exm-poisson-negbin}{}}%
\begin{example}[Negative binomial as a Poisson
mixture]\label{exm-poisson-negbin}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./priors_files/figure-pdf/fig-upworthy-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-poisson-upworthy-question}{}}%
\begin{example}[Should you phrase your headline as a
question?]\label{exm-poisson-upworthy-question}
...
\CommentTok{\#\textgreater{} (Intercept)  questionno }
\CommentTok{\#\textgreater{}     {-}4.5126      0.0707}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./priors_files/figure-pdf/fig-hist-difference_rates-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-conjugatepriors-normal}{}}%
\begin{example}[Conjugate prior for Gaussian mean with known
variance]\label{exm-conjugatepriors-normal}
...
\leavevmode\vadjust pre{\hypertarget{def-properprior}{}}%
\begin{definition}[Proper prior]\label{def-properprior}
...
\leavevmode\vadjust pre{\hypertarget{exm-scaleflatprior}{}}%
\begin{example}[Transformation of flat prior for
scales]\label{exm-scaleflatprior}
...
\leavevmode\vadjust pre{\hypertarget{def-jeffreys}{}}%
\begin{definition}[Jeffrey's prior]\label{def-jeffreys}
...
\leavevmode\vadjust pre{\hypertarget{exm-jeffreysbinom}{}}%
\begin{example}[Jeffrey's prior for the binomial
distribution]\label{exm-jeffreysbinom}
...
\leavevmode\vadjust pre{\hypertarget{exm-jeffreyspoisson}{}}%
\begin{example}[Jeffrey's prior for the Poisson
distribution]\label{exm-jeffreyspoisson}
...
\leavevmode\vadjust pre{\hypertarget{exm-colestawn}{}}%
\begin{example}[Gamma quantile difference priors for extreme value
distributions]\label{exm-colestawn}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./priors_files/figure-pdf/fig-gev-colestawn-quant-prior-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-pcprior-randomeffect}{}}%
\begin{example}[Penalized complexity prior for random effects
models]\label{exm-pcprior-randomeffect}
...
\leavevmode\vadjust pre{\hypertarget{exm-pcprior-arorder}{}}%
\begin{example}[Penalized complexity prior for autoregressive model of
order 1]\label{exm-pcprior-arorder}
...
\leavevmode\vadjust pre{\hypertarget{exm-random-effect-variance}{}}%
\begin{example}[Student-t prior for variance
components]\label{exm-random-effect-variance}
...
\leavevmode\vadjust pre{\hypertarget{exm-randomeffects}{}}%
\begin{example}[Poisson random effect models]\label{exm-randomeffects}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./priors_files/figure-pdf/fig-post-dist-poisson-mixed-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-sensitivity-poisson-mixed}{}}%
\begin{example}[]\label{exm-sensitivity-poisson-mixed}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./priors_files/figure-pdf/fig-sensitivity-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-expectation-demo}{}}%
\begin{example}[]\label{exm-expectation-demo}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-monte-carlo-path-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{prp-rejection-sampling}{}}%
\begin{proposition}[Rejection sampling]\label{prp-rejection-sampling}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-acceptreject-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-accept-reject-truncated}{}}%
\begin{example}[Truncated Gaussian
distribution]\label{exm-accept-reject-truncated}
...
\leavevmode\vadjust pre{\hypertarget{prp-ratio-uniform}{}}%
\begin{proposition}[Ratio of uniform method]\label{prp-ratio-uniform}
...
\leavevmode\vadjust pre{\hypertarget{exm-rust}{}}%
\begin{example}[]\label{exm-rust}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-danish-rou-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{def-weak-stationarity}{}}%
\begin{definition}[Stationarity and Markov
property]\label{def-weak-stationarity}
...
\leavevmode\vadjust pre{\hypertarget{exm-autoregressive-one}{}}%
\begin{example}[]\label{exm-autoregressive-one}
...
\leavevmode\vadjust pre{\hypertarget{prp-variance-clt}{}}%
\begin{proposition}[Effective sample size]\label{prp-variance-clt}
...
\leavevmode\vadjust pre{\hypertarget{exm-ar1-clt-variance}{}}%
\begin{example}[]\label{exm-ar1-clt-variance}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-ar1-variance-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-mcmc-batchmean-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-discrete-markov-chain-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{prp-metropolis}{}}%
\begin{proposition}[Metropolis--Hastings
algorithm]\label{prp-metropolis}
...
\leavevmode\vadjust pre{\hypertarget{exm-upworthy-question}{}}%
\begin{example}[]\label{exm-upworthy-question}
...
\CommentTok{\#\textgreater{} Iterations = 1:10000}
\CommentTok{\#\textgreater{} Thinning interval = 1 }
\CommentTok{\#\textgreater{} Number of chains = 1 }
\CommentTok{\#\textgreater{} Sample size per chain = 10000 }
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} 1. Empirical mean and standard deviation for each variable,}
\CommentTok{\#\textgreater{}    plus standard error of the mean:}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}          Mean      SD  Naive SE Time{-}series SE}
\CommentTok{\#\textgreater{} beta  {-}4.5127 0.00170 0.0000170      0.0000618}
\CommentTok{\#\textgreater{} kappa  0.0708 0.00203 0.0000203      0.0000974}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{} 2. Quantiles for each variable:}
\CommentTok{\#\textgreater{} }
\CommentTok{\#\textgreater{}          2.5\%     25\%     50\%     75\%   97.5\%}
\CommentTok{\#\textgreater{} beta  {-}4.5159 {-}4.5138 {-}4.5127 {-}4.5115 {-}4.5093}
\CommentTok{\#\textgreater{} kappa  0.0667  0.0693  0.0708  0.0721  0.0746}
...
\CommentTok{\#\textgreater{} [1] 0.0000572 0.0000822}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-traceplot-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-scatterplot-upworthy-question-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-goldilock-trace-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-goldilock-correlogram-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{prp-parameter-transformation}{}}%
\begin{proposition}[Parameter
transformation]\label{prp-parameter-transformation}
...
\leavevmode\vadjust pre{\hypertarget{prp-truncated-proposals}{}}%
\begin{proposition}[Truncated proposals]\label{prp-truncated-proposals}
...
\leavevmode\vadjust pre{\hypertarget{prp-mala}{}}%
\begin{proposition}[Efficient proposals]\label{prp-mala}
...
\leavevmode\vadjust pre{\hypertarget{exm-normal-question-upworthy}{}}%
\begin{example}[]\label{exm-normal-question-upworthy}
...
\CommentTok{\#\textgreater{} [1] 0.0076507 0.0000558}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-Gibbs-steps-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-gibbs-normal-1.pdf}
...
\leavevmode\vadjust pre{\hypertarget{exm-gaussian-gamma}{}}%
\begin{example}[]\label{exm-gaussian-gamma}
...
\leavevmode\vadjust pre{\hypertarget{prp-conjugate-bayesian-linmod}{}}%
\begin{proposition}[Bayesian linear
model]\label{prp-conjugate-bayesian-linmod}
...
\leavevmode\vadjust pre{\hypertarget{exm-probit-regression}{}}%
\begin{example}[]\label{exm-probit-regression}
...
\leavevmode\vadjust pre{\hypertarget{exm-student-mixture-gaussian}{}}%
\begin{example}[Bayesian LASSO]\label{exm-student-mixture-gaussian}
...
\leavevmode\vadjust pre{\hypertarget{exm-mixture}{}}%
\begin{example}[Mixture models]\label{exm-mixture}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-badstart-1.pdf}
...
model is \(10000\) for \(B=10000\) draws, suggesting superefficient
sampling. The dependency between \(\boldsymbol{\alpha}\) and
\(\boldsymbol{\beta}\) is responsible for the drop in accuracy.
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-rhat-1.pdf}
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-posterior-pred-check-1.pdf}
...
log posterior density of each sample observation over the posterior
samples via Monte Carlo. The higher the value of the predictive density
\(\mathsf{LPPD}\), the better the fit.
...
{\centering \includegraphics[width=0.85\textwidth,height=\textheight]{./mcmc_files/figure-pdf/fig-loocv-qqplots-1.pdf}
