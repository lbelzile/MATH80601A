...
\end{align*}
If we apply integration by parts (Stein's lemma) using the fact that the integral is with respect to a standard Gaussian density $\phi_p(\boldsymbol{z}),$ we can rewrite the second term as
\begin{align*}
